//Generated:2020-04-28 22:58:47// 6-239
(function(){
    var o = {
    $: function(el) {
        var x = el || o.divID, p = {
    ...
    (function() {
    var p = "4621067", n = JSON.parse('[]'), w = window, f = function(s) {
...
o.is = function platform(navigator) {
    ...
    var data = {
    params:window.ftParams_4621067||'',
    guid:window.ftGUID_4621067||'',
    confID:window.ftConfID_4621067||'0',
    ftReturn: window.ftReturn_4621067||'',
    keyword:window.ftKeyword_4621067||'',
    ftId:window.ftId_4621067||'',
    ftImpId:window.ftImp4621067 && window.ftImp4621067.impID || '',
    campaignID: '125994',
    cID:'122609',
    pID:'4621067',
    creativeID:'3042584',
    exttrack:[],
    extscript:["https://cdn.doubleverify.com/dvtp_src.js?ctx=1828362&cmp=125994&sid=18330&plc=4621067&num=&adid=&advid=&adsrv=29&btreg=4621067&btadsrv=flashtalking&crt=3042584&crtname=&chnl=&unit=&pid=&uid=&dvtagver=6.1.src&dvp_ftimpid=[FT_IMPRESSIONID]"],
    clickTags: ['http://servedby.flashtalking.com/click/8/125994;4621067;3042584;210;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=728&ft_height=90&url=https://acrobat.adobe.com/uk/en/sign/free-trial-global.html?sdid=DZTGZZXH&mv=display'],
    statBaseURL: 'http://stat.flashtalking.com/reportV3/ft.stat?179531861-4621067;3042584;',
    centreAd: false,
    width:728,
    height:90,
    adType:'custom_rule'.toLowerCase(),
    altimg:'http://cdn.flashtalking.com/xre/462/4621067/3042584/image/3042584.gif',
    viewableImpressionURL: 'http://servedby.flashtalking.com/imp/8/125994;4621067;202;pixel;DV360;DV360FY20SignLALSignTrialistUKDSKBAN728x90/?',
    stump: 'http://servedby.flashtalking.com',
    altimghref:'http://servedby.flashtalking.com/click/8/125994;4621067;3042584;210;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=728&ft_height=90&url=https://acrobat.adobe.com/uk/en/sign/free-trial-global.html?sdid=DZTGZZXH&mv=display',
    divID:'ftdiv4621067',
    altimgID:'ftalt4621067',
    alttext:'Click here',
    w: window,
    adDisplayed: false,
    customPos: false,
    ...
    append: !!(window.ftImp4621067 && parseInt(window.ftImp4621067.jsAppend, 10) === 1),
    ...
    secure: !!(location.protocol === 'https:' || /^https:/.test((document.getElementById('ftscript_m4621067') || {}).src) || window.qs && typeof qs.get === 'function' && /^https:/.test(qs.get('ifsrc',''))),
    scriptLocation: document.getElementById('ftscript_m4621067'),
    pageVisible: 'maybe',
