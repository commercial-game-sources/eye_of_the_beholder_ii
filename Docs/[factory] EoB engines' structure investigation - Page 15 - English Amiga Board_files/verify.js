    ...
    try{
        ...
        var msg = {
            ...
            bsAdEntityInformation: {
                brandShieldId:'3bf00222ef84428b82f021f39ceba552',
        ...
        var findAndSendMessage = function() {
            if (!bst2tWin) {
                var frame = document.getElementById('bst2t_848993707048');
                if (frame) {
...
;np764531("3bf00222ef84428b82f021f39ceba552",false);


try{__tagObject_callback_848993707048({ImpressionID:"3bf00222ef84428b82f021f39ceba552", ServerPublicDns:"tps20519.doubleverify.com"});}catch(e){}
try{$dvbs.pubSub.publish('BeforeDecisionRender', "3bf00222ef84428b82f021f39ceba552");}catch(e){}
try{__verify_callback_848993707048({
ResultID:2,
Passback:"",
AdWidth:728,
AdHeight:90});}catch(e){}
try{$dvbs.pubSub.publish('AfterDecisionRender', "3bf00222ef84428b82f021f39ceba552");}catch(e){}
